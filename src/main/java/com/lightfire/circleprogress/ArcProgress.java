...
import com.portalgrup.circleprogress.R;
...
public class ArcProgress extends View {
    ...
    private final float default_unufinished_stroke_width;
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_unufinished_stroke_width = Utils.dp2px(getResources(),1);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        unfinishedStrokeWidth = attributes.getDimension(R.styleable.ArcProgress_arc_unfinished_stroke_width,default_unufinished_stroke_width);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(unfinishedStrokeWidth);
